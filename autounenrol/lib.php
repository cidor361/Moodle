...
/**
 * The enrol plugin autounenrol is defined here.
 *
...
/**
 * Class enrol_autounenrol_plugin.
 */
class enrol_autounenrol_plugin extends enrol_plugin {
     ...
     * @return bool True means user with 'enrol/autounenrol:unenrol' may unenrol this user, false means nobody may touch this user enrolment.
     */
